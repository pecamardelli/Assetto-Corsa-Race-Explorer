...
/**
 * Editor for one round's race settings, opened from its card on the season page.
 * Saving writes an override for that round alone; "Use championship settings"
  ...
  return (
    <>
      <button
        ...
        className="inline-flex shrink-0 items-center gap-2 rounded-lg bg-cyan-500/20 px-3 py-1.5 text-sm font-medium text-cyan-400 transition-all hover:bg-cyan-500/30"
      >
