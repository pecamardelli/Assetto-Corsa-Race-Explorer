...
import { readGlobalAssists } from '../lib/launch/assists';
        ...
        <div className="mb-8">
          ...
          <div className="rounded-lg border border-zinc-700 bg-zinc-800/50 p-6">
            ...
            <p className="text-zinc-400">
              Driving aids and realism settings written to Assetto Corsa on every
              launch. Every season uses these until it gets presets of its own.
            </p>
          </div>
        </div>

        <AssistsEditor initial={assists} initialSource="global" />
      </div>
    </div>
  );
}
