...
export default async function SeasonPage({
  ...
  // A road season: one whose rounds go out in the Test Drive mode. Only those let the
  // car be chosen rather than taken from the .champ — see the car page for why.
  const roadSeason = data.rounds.some(usesTrafficMode);
              ...
              >
                ...
                >
                  <path
                    ...
                    strokeLinejoin="round"
                    strokeWidth={2}
                    d="M8 17a2 2 0 11-4 0 2 2 0 014 0zm12 0a2 2 0 11-4 0 2 2 0 014 0zM4 17H3v-4l2-5h11l3 5v4h-1M8 17h8"
                  />
                </svg>
                Your Car
              </Link>
